...
name_session ="mask_rcnn_transformer_NoiseBlur"
...
import sys
sys.path.insert(0, "/home/student/Documents/Mask2Former")  # NOT the 'mask2former' subdir directly
# Now you can import as a package
...
import sys
sys.path.insert(0, "/home/student/Documents/Mask2Former")

from train_net import Trainer as MaskFormerTrainer
...
class MyTrainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        if output_folder is None:
            os.makedirs("eval_transformer_nb", exist_ok=True)
            output_folder = "eval_transformer_nb"
...
os.makedirs("/home/student/Documents/Project7.v4-noise_blur.coco/train_samples_50_transformer_nb", exist_ok=True)
...
output_filename = f"/home/student/Documents/Project7.v4-noise_blur.coco/train_samples_50_transformer_nb/output_50_transformer_nb_{os.path.basename(d['file_name'])}"
cv2.imwrite(output_filename, out.get_image()[:, :, ::-1])

print(f"Dataset created!!!!")
custom_output_dir = "/home/student/Documents/Project7.v1-no_augmentation.coco/train/train_samples_50_transformer_nb"
...
cfg.merge_from_file("/home/student/Documents/maskformer2_swin_tiny_bs16_50ep.yaml")
...
cfg.MODEL.WEIGHTS = ("/home/student/Documents/model_final_9fd0ae.pkl")  # Let training initialize from model zoo
...
cfg.SOLVER.CHECKPOINT_PERIOD = 1000  # or 1000 or any reasonable value
...
cfg.OUTPUT_DIR = "/home/student/Documents/output_50_transformer_nb"
...
evaluator = COCOEvaluator(
    ...
    distributed=False,
    output_dir="./output_50_transformer_nb"
)


metrics_50_transformer_nb = inference_on_dataset(predictor.model, val_loader, evaluator)

flat_metrics_50_transformer_nb = {}
for task in ("bbox", "segm"):
    if task in metrics_50_transformer_nb:
        for k, v in metrics_50_transformer_nb[task].items():
            metrics_50_transformer_nb[f"{task}_{k.replace(' ', '_')}"] = v

# Log with step=0 to ensure visibility in the dashboard
if flat_metrics_50_transformer_nb:
    wandb.log(flat_metrics_50_transformer_nb, step=0)
...
df = pd.DataFrame([flat_metrics_50_transformer_nb])
df.to_csv("detectron2_metrics_50_transformer_nb.csv", index=False)
