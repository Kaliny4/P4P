...
os.makedirs(
    "/home/student/Documents/Project7.v4-noise_blur.coco/train_samples_50_transformer_nb",
    exist_ok=True,
)
...
print(f"✅ Sample visualizations saved to {output_filename}")
...
cfg.SOLVER.IMS_PER_BATCH = (
    1  # This is the real "batch size" commonly known to deep learning people
)
