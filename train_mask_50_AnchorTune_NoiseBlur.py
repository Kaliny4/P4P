...
os.makedirs("/home/student/Documents/Project7.v4-noise_blur.coco/train_samples_50_ray_best_nb_new", exist_ok=True)
...
cfg.MODEL.ANCHOR_GENERATOR.SIZES = [[8, 16, 32, 64, 128, 256, 5]]#[[16, 32, 64, 128, 256]]  # smaller anchors for plants
cfg.MODEL.ANCHOR_GENERATOR.ASPECT_RATIOS =  [[0.25, 0.5, 0.75, 1.0, 1.25, 1.5, 1.75]]#[[0.3, 0.5, 1.0]] # tall and square plants
...
metrics_50_ray_best_nb_new = inference_on_dataset(predictor.model, val_loader, evaluator)
