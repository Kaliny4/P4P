...
input_folder = "/home/student/Documents/Project7.v1-no_augmentation.coco/valid"
output_image_folder = "/home/student/Documents/output_ray_50b_nb/predicted_images"
output_json_path = "/home/student/Documents/output_ray_50b_nb/instances_predictions_test.json"
...
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 2  # Update if your model has a different number of classes
...
for image_id, filename in enumerate(image_files, start=1):
    ...
    v = Visualizer(image[:, :, ::-1], metadata=metadata, scale=0.5, instance_mode=ColorMode.IMAGE_BW)
